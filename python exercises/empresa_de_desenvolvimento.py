...
class Programador(Empregado):
    ...
    def __init__(self, valor_por_projeto: int, habilidade_programacao: int):
        ...
        self.__habilidade_programação = habilidade_programacao
    

    # TODO: Um programador deve ser capaz de entregar um projeto se sua habilidade 
    # de programação é maior que o requisito de programação do projeto.
    def capaz(self, projeto: Projeto) -> bool:
        if projeto.requisito_programacao <= self.__habilidade_programação:
            return True
...
class Designer(Empregado):
    ...
    # TODO: Um designer deve ser capaz de entregar um projeto se sua habilidade de 
    # design é maior que o requisito de design do projeto.
    def capaz(self, projeto: Projeto) -> bool:
        if projeto.requisito_design <= self.__habilidade_design:
            return True
...
if __name__ == "__main__":
    ...
    for i in range(n):
        ...
        # TODO:Use os métodos das classes acima para calcular quando tanto o programador quanto 
        # o designer conseguem desenvolver o projeto P e dê a recompensa a cada um caso eles consigam.
