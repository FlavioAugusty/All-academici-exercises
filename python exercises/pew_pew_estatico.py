class Inimigo:
    ...
    # TODO: Método que muda a o status do inimigo de vivo para morto caso seja acertado pelo lazer na 
    # posição (X,Y). Também deve atualizar a variável quantidade_vivos.
