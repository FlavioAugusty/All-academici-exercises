...
public:
    ...
    //TODO: Um programador deve ser capaz de entregar um projeto se sua habilidade de programação é 
    //maior que o requisito de programação do projeto.
    bool capaz(Projeto P){
...
int main(){
    ...
    for(int i=0;i<N;i++){
        ...
        //TODO:Use os métodos das classes acima para calcular quando tanto o programador 
        //quanto o designer conseguem desenvolver o projeto P e dê a recompensa a cada um caso eles consigam.
    }
